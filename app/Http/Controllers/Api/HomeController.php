        ...
        try {
            ...
            if ($insert->save()) {
                ...
                if (isset($user_data) && isset($video_data)) {
                    ...
                    // Send Mail
                    if (setting_app_name() == "") {
                        $title = env('APP_NAME') . " - Rent Transaction";
                    } else {
                        $title = setting_app_name() . " - Rent Transaction";
                    }
                    $c_code = currency_code();
                    $body = 'You have successfully Rent ' . $video_data->name . ' in ' . $c_code . ' ' . $price . '.';
                    $details = [
                        'title' => $title,
                        'body' => $body
                    ];
            ...
            if ($insert->save()) {
                ...
                if (isset($user_data)) {
                    ...
                    if (setting_app_name() == "") {
                        ...
                        $title = setting_app_name() . " - Transaction";
                    }
                    $c_code = currency_code();
                    $body = 'You have successfully Purchased ' . $Pdata->name . ' Subscription Plan for ' . $c_code . ' ' . $amount . '.';
                    $details = [
                        'title' => $title,
                        'body' => $body
                    ];
