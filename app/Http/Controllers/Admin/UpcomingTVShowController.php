        ...
        try {
            if ($_GET['session'] != "All") {
                ...
                if (isset($_GET['session'])) {
                    ...
                    return view('admin.upcoming_tv_show.video_list', ['tvshowId' => $request->show_id, 'result' => $video_list, 'session' => $session]);
                }
            } else {
                return redirect()->route('upcomingTVShowVideo', ['id' => $request->show_id]);
            }
        } catch (Exception $e) {
            return response()->json(array('status' => 400, 'errors' => $e->getMessage()));
        }
