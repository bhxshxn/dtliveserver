...
class AdminController extends Controller
{
    public function dashboard()
    {
        try {
            ...
            $params['total_month_rent_transaction'] = RentTransction::whereMonth('date', date('m'))->whereYear('date', date('Y'))->sum('price');
            ...
            for ($i = 1; $i < 13; $i++) {
                ...
                $Sum = RentTransction::whereYear('date', date('Y'))->whereMonth('date', $i)->sum('price');
