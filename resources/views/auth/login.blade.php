                    ...
                    <div class="py-5 p-3">
                        ...
                        <div class="app-logo mb-4">
                            ...
                            <a class="mb-4 d-block d-lg-none">
                                <h3 class="primary-color mb-0 font-weight-bold">{{ env('APP_NAME')}}</h3>
                            </a>
                            @else
                            <a class="mb-4 d-block d-lg-none">
                                <h3 class="primary-color mb-0 font-weight-bold">{{setting_app_name()}}</h3>
                            </a>
                            @endif
                            ...
                            <div class="form-row mt-4">
                                <div class="col-md-6">
                                    <div class="position-relative form-group">
                                        <label>Email</label>
                                        <input name="email" placeholder="Email here..." type="email" class="form-control" value="admin@admin.com" required autofocus>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="position-relative form-group">
                                        <label>Password</label>
                                        <input name="password" placeholder="Password here..." type="password" class="form-control" value="admin" required>
                                    </div>
                                </div>
                            </div>
